...
describe('App', function(){
    ...
    it('add item and price to get total $18', function(){
        ...
        assert.equal(shop.getTotal(), '17')
    })
    it('add multiple items get total', function(){
        ...
        assert.equal(shop.getTotal(), '36')
    })
    it('apply 20% discount to total', function(){
        assert.equal(shop.getDiscount(20), '29')
    })
